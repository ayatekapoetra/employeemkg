...
import { BrifecaseTimer, EmptyWalletTime, Hospital, NoteFavorite, Personalcard, ShieldTick, TimerStart, TruckTime } from 'iconsax-react-native'
    ...
    const state = [
        {
            ...
            icon: <BrifecaseTimer size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
        ...
        },
        {
            ...
            icon: <TimerStart size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
        ...
        },
        {
            ...
            icon: <Personalcard size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
        ...
        },
        {
            ...
            icon: <Hospital size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
        ...
        },
        {
            ...
            icon: <NoteFavorite size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
            uri: '',
            authorized: 'segment'
        },
        {
            ...
            icon: <ShieldTick size="32" color={appcolor.teks[mode][2]} variant="Bulk"/>,
            uri: '',
            authorized: 'segment'
        }
    ]
        ...
        <AppScreen>
            <VStack h={"full"}>
                ...
                <VStack px={3} mt={2} flex={1}>
                    <FlatList data={state} renderItem={({item}) => <BtnListApproval mode={mode} item={item}/>} keyExtractor={item => item.id}/>
                </VStack>
            </VStack>
        </AppScreen>
    )
