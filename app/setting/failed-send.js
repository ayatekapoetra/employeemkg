...
export default function FailedSendScreen() {
  ...
  const developmentStages = [
    ...
    { label: 'Design', progress: 75, status: 'in-progress' },
    { label: 'Development', progress: 40, status: 'in-progress' },
    { label: 'Testing', progress: 0, status: 'pending' },
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <VStack space={6} p={4}>
            <Animated.View style={{ opacity: fadeAnim }}>
              <VStack bg={mode === 'dark' ? '#7f1d1d' : '#fee2e2'} p={8} rounded="3xl" alignItems="center" space={4}>
                <Center w={32} h={32} bg="rgba(255,255,255,0.3)" rounded="full" mb={2}>
                  <Text fontSize="6xl">🔄</Text>
                </Center>
                <VStack alignItems="center" space={2}>
                  <Text fontSize="2xl" fontFamily="Quicksand-Bold" color={mode === 'dark' ? '#ef4444' : '#dc2626'} textAlign="center">
                    Segera Hadir!
                  </Text>
                  <Text fontSize="sm" fontFamily="Poppins-Light" color={mode === 'dark' ? '#ef4444' : '#dc2626'} textAlign="center" opacity={0.9}>
                    Fitur Gagal Kirim sedang dalam pengembangan
                  </Text>
                </VStack>
                <HStack space={2} mt={2}>
                  {[0, 1, 2].map((i) => (
