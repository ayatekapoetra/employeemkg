...
const RiwayatAbsensiBulananPage = () => {
    ...
    return (
        <AppScreen>
            <VStack h={"full"}>
                <HeaderScreen title={"Kehadiran Bulanan"} onBack={true} onThemes={true} onFilter={onOpenFilterHandle} onNotification={true}/>
...
export default RiwayatAbsensiBulananPage