...
const FilterApprovalAbsenTulis = ( { openFilter, setOpenFilter, filterData, setFilterData } ) => {
        ...
        <VStack mx={3}>
            ...
            <Actionsheet isOpen={isOpenSheet} onClose={() => setOpenSheet(false)}>
                <Actionsheet.Content>
                    ...
                    <Actionsheet.Item onPress={() => changeStatusKehadiran(' ')}>Menunggu Persetujuan</Actionsheet.Item>
                    <Actionsheet.Item onPress={() => changeStatusKehadiran('A')}>Telah di Setujui</Actionsheet.Item>
...
export default FilterApprovalAbsenTulis