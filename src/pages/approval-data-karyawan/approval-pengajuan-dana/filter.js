...
const dataStatus = [
    {id: 1, nama: 'Pengajuan Baru', status: ['open']},
    {id: 2, nama: 'Menunggu Verify Keuangan', status: ['approval']},
    {id: 3, nama: 'Pengajuan Selesai', status: ['close']},
    {id: 4, nama: 'Pengajuan Ditolak', status: ['reject']},
    {id: 5, nama: 'Semua Status', status: ['open', 'approval', 'close', 'verify']},
    {id: 6, nama: 'Selain Yang Telah Selesai', status: ['open', 'verify', 'approval']},
]

const FilterPengajuanDana = ( { applyFilter, resetFilter, qstring, setQstring } ) => {
    ...
    return (
        <VStack flex={1}>
            <VStack flex={1}>
                ...
                <TouchableOpacity onPress={() => setOpenKode(!openKode)}>
                    <HStack p={2} mb={3} space={1} rounded={'md'} borderWidth={.5} borderColor={appcolor.line[mode][1]}>
...
export default FilterPengajuanDana