...
const FilterApprovalLemburKaryawan = ( { openFilter, setOpenFilter, filterData, setFilterData } ) => {
    ...
    const changeStatusLembur = async (sts) => {
        setFilterData({
            ...filterData,
            status: sts
        })
    ...
    switch (filterData.status) {
        case 'ALL':
            var statusPersetujuan = "Semua Data";
            break;
        case 'C':
            var statusPersetujuan = "Diterima oleh karyawan";
            break;
        case 'A':
            var statusPersetujuan = "Disetujui Penanggung Jawab";
        case 'F':
            var statusPersetujuan = "Menunggu Persetujuan";
            break;
        default:
            var statusPersetujuan = "Perintah Lembur Baru";
            break;
    }
        ...
        <VStack mx={3}>
            ...
            <Actionsheet isOpen={isOpenSheet} onClose={() => setOpenSheet(false)}>
                <Actionsheet.Content>
                    ...
                    <Actionsheet.Item onPress={() => changeStatusLembur('ALL')}>Semua Data Lembur</Actionsheet.Item>
                    <Actionsheet.Item onPress={() => {
                        setFilterData({...filterData, status: ""})
                        setOpenSheet(false)
                    }}>Perintah Lembur Baru</Actionsheet.Item>
                    <Actionsheet.Item onPress={() => changeStatusLembur('C')}>Diterima oleh karyawan</Actionsheet.Item>
                    <Actionsheet.Item onPress={() => changeStatusLembur('F')}>Diselesaikan oleh karyawan</Actionsheet.Item>
                    <Actionsheet.Item onPress={() => changeStatusLembur('A')}>Disetujui oleh Penanggung Jawab</Actionsheet.Item>
                </Actionsheet.Content>
            </Actionsheet>
...
export default FilterApprovalLemburKaryawan