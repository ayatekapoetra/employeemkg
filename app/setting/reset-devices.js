...
export default function ResetDevicesScreen() {
  ...
  const developmentStages = [
    ...
    { label: 'Design', progress: 90, status: 'in-progress' },
    { label: 'Development', progress: 55, status: 'in-progress' },
    { label: 'Testing', progress: 20, status: 'pending' },
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <VStack space={6} p={4}>
            <Animated.View style={{ opacity: fadeAnim }}>
              <VStack bg={mode === 'dark' ? '#164e63' : '#cffafe'} p={8} rounded="3xl" alignItems="center" space={4}>
                <Center w={32} h={32} bg="rgba(255,255,255,0.3)" rounded="full" mb={2}>
                  <Text fontSize="6xl">📱</Text>
                </Center>
                <VStack alignItems="center" space={2}>
                  <Text fontSize="2xl" fontFamily="Quicksand-Bold" color={mode === 'dark' ? '#06b6d4' : '#0891b2'} textAlign="center">
                    Segera Hadir!
                  </Text>
                  <Text fontSize="sm" fontFamily="Poppins-Light" color={mode === 'dark' ? '#06b6d4' : '#0891b2'} textAlign="center" opacity={0.9}>
                    Fitur Reset UUID Devices sedang dalam pengembangan
                  </Text>
                </VStack>
                <HStack space={2} mt={2}>
                  {[0, 1, 2].map((i) => (
                    <Animated.View
                      ...
                      style={{
                        ...
                        height: 8,
                        borderRadius: 4,
                        backgroundColor: mode === 'dark' ? '#06b6d4' : '#0891b2',
