...
import ShowBtnAction from '../../permintaan-absensi-karyawan/informasi-sakit/showBtnAction'
// import ShowBtnAction from './showBtnAction'


const ShowApprovalIzinSakit = () => {
    ...
    const onGetDataHandle = async () => {
        try {
            const resp = await apiFetch.get(`hrd/permohonan-izin-sakit/${params.id}/show`)
            // console.log(resp);
    ...
    return (
        <AppScreen>
            <VStack h={"full"}>
                <HeaderScreen title={"Approval Informasi Sakit"} onBack={true} onThemes={true} onNotification={true}/>
                <VStack px={3} flex={1}>
                    <VStack mt={1}>
                        <HStack 
                            p={2} 
                                    ...
                                    <VStack flex={1}>
                                        ...
                                        </Text>
                                        {
                                            ...
                                            <Text 
                                                ...
                                                color={appcolor.teks[mode][3]}>
                                                { moment(data?.approved_at).format("DD/MM/YY HH:mm") }
                                            </Text>
                                            :
                                            <Text 
                                                fontSize={12}
...
export default ShowApprovalIzinSakit