...
import { Image, ArrowRight2, Calendar1, Camera, MessageText1, User, Like1, Calculator } from 'iconsax-react-native'
...
const CreateFormCuti = () => {
    ...
    const [ data, setData ] = useState({
        ...
        cuti_start: new Date(),
        cuti_end: new Date(moment().add(1, 'd')),
        work_start: new Date(moment().add(2, 'd')),
        jumlah: 1,
        narasi: ""
    })
    ...
    const onPostDataHandle = async () => {
        ...
        try {
            const resp = await apiFetch.post("hrd/permohonan-izin-cuti", data)
    ...
    return (
        <AppScreen>
            <VStack h={"full"}>
                <HeaderScreen title={"Form Pengajuan Cuti"} onBack={true} onThemes={true} onNotification={true}/>
                <VStack px={3} flex={1}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                                    ...
                                    <HStack space={2} alignItems={"center"}>
                                        ...
                                        <VStack>
                                            ...
                                            <Text 
                                                ...
                                                fontFamily={"Quicksand-Regular"}
                                                color={appcolor.teks[mode][1]}>
                                                { moment(data.cuti_start).format('dddd, DD MMMM YYYY') }
                                            </Text>
                                        </VStack>
                                    </HStack>
                                    <ArrowRight2 size="16" color={appcolor.ico[mode][1]} variant="TwoTone"/>
                        ...
                        <DatePicker
                            ...
                            onConfirm={(date) => {
                                ...
                                setData({...data, cuti_start: date, jumlah: finish.diff(start, 'day')})
                            }}
                            onCancel={() => {
                                    ...
                                    <HStack space={2} alignItems={"center"}>
                                        ...
                                        <VStack>
                                            ...
                                            <Text 
                                                ...
                                                fontFamily={"Quicksand-Regular"}
                                                color={appcolor.teks[mode][1]}>
                                                { moment(data.cuti_end).format('dddd, DD MMMM YYYY') }
                                            </Text>
                                        </VStack>
                                    </HStack>
                                    <ArrowRight2 size="16" color={appcolor.ico[mode][1]} variant="TwoTone"/>
                        ...
                        <DatePicker
                            ...
                            onConfirm={(date) => {
                                ...
                                setData({...data, cuti_end: date, jumlah: finish.diff(start, 'day')})
                            }}
                            onCancel={() => {
